...
public class ByteBufferSetUtil
{
    ...
    static int putRemaining(final ByteBuffer from, final ByteBuffer[] buffers, final int offset, final int length)
    {
      int totalBytes = 0;
      for (int i = offset; i < offset + length; i++) {
    ...
    static void put(final ByteBuffer from, final int fromLength, final ByteBuffer[] buffers, final int offset, final int length, final long remaining)
    {
    ...
    static int getRemaining(final ByteBuffer dst, final ByteBuffer[] buffers, final int offset, final int length)
    {
      int totalBytes = 0;
      for (int i = offset; i < offset + length; i++) {
    ...
    static void get(final ByteBuffer dst, final int dstLength, final long remaining, final ByteBuffer[] buffers, final int offset, final int length)
    {
