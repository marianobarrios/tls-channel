...
/**
 * This exception signals the caller that the operation cannot continue because bytes need
 * to be written to the underlying {@link ByteChannel}, the channel is non-blocking and there is no
 * buffer space available. The caller should try the operation again, either with the channel in
 * blocking mode or after ensuring that buffer space exists.
 *
