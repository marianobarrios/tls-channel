...
/**
 * <p> Server asynchronous example. Accepts any number of connections and echos bytes sent by the clients into standard
 * output.</p>
 *
 * <p> To test, use: </p>
 *
 ...
 *
 * <p> This class exemplifies the use of {@link AsynchronousTlsChannel}. It implements a blocking select loop, that
 * processes new connections asynchronously using asynchronous channel and callbacks, hiding the complexity of a
 * select loop.
 */
